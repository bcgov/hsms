...
#export 3 tables
bed_file_name = "W:/Path/to/CMHC_PRM.csv"
range_file_name = "W:/Path/to/CMHC_PRM_Rent_Ranges.csv"
structure_file_name = "W:/Path/to/CMHC_PRM_Structure_Size.csv"
summary_file_name = "W:/Path/to/CMHC_PRM_Sum_Stats.csv"
